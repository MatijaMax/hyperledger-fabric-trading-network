...
USER_JSON='{"id":"u1","name":"MATIJA","last_name":"MAKS","email":"matmaks@gmail.com","receipts_ids":[],"account_balance":100}'
invoke_function CreateUser json "$USER_JSON"
query_function ReadUser u1
query_function GetAllUsers

infoln "Testing advanced queries"
QUERY_JSON='{"price":"2"}'
invoke_function QueryProducts json "$QUERY_JSON"  
query_function SearchUsersByLastName MAKS
query_function SearchUsersByName MATIJA
query_function GetUsersGTEBalance 300
query_function GetUsersGTEBalance 180

infoln "Testing products"
invoke_function DeleteProduct raw pppp1
PRODUCT_JSON='{"id":"haribo","name":"h1","expiration_date":"", "price":2,"quantity":2,"trader_id":"tr1"}'
invoke_function CreateProduct json "$PRODUCT_JSON"
query_function ReadProduct pppp1
invoke_function BuyProduct raw haribo u1
query_function GetAllProducts
query_function ReadUser u1

infoln "Testing traders"
invoke_function DeleteTrader raw tr4
TRADER_JSON='{"id":"tr4","trader_type":"FOOD","pib":"pibpibpib","products":["or1"],"receipts":[],"account_balance":100}'
invoke_function CreateTrader json "$TRADER_JSON"
query_function GetAllTraders
query_function ReadTrader tr4
